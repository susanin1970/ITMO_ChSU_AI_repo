...
from src.backend.database_service.schemas.database_service_schemas import GlaucomaPydantic
...
@router.get("/database", response_model=GlaucomaPydantic, status_code=status.HTTP_200_OK)
