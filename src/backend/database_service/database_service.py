...
#  project
from src.backend.database_service.schemas.service_config import (
    CommonSettingsConfiguration,
)
from src.backend.neuralnets_serivce.tools.service_tools import Server

def get_service(
    service_config: CommonSettingsConfiguration,
    num_workers: int = 0,
    reload: bool = False,
):
    ...
    config = uvicorn.Config(
        "src.backend.database_service.app:app",
...
def main() -> None:
    ...
    service_config_path = "src/backend/database_service/configs/service_config.json"
